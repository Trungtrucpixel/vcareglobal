...
export interface IStorage {
  ...
  // VCA Digital Share operations
  getVcaDigitalShareHistory(userId?: string): Promise<Array<{date: string; amount: string; type: string; description: string}>>;
...
export class MemStorage implements IStorage {
  ...
  // VCA Digital Share operations
  async getVcaDigitalShareHistory(userId?: string): Promise<Array<{date: string; amount: string; type: string; description: string}>> {
