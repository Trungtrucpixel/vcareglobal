...
export const users = pgTable("users", {
  ...
  vcaDigitalShare: decimal("vca_digital_share", { precision: 15, scale: 2 }).default("0"), // VCA Digital Share balance (100 VCA = 1M VND)
...
export const assetContributions = pgTable("asset_contributions", {
  ...
  vcaDigitalShareAmount: decimal("vca_digital_share_amount", { precision: 15, scale: 2 }).notNull(), // Số VCA Digital Share tương ứng
...
export const cards = pgTable("cards", {
  ...
  vcaDigitalShare: decimal("vca_digital_share", { precision: 15, scale: 2 }).default("0"), // VCA Digital Share (100 VCA = 1 triệu VNĐ)
...
export const branches = pgTable("branches", {
  ...
  vcaDigitalShare: decimal("vca_digital_share", { precision: 15, scale: 2 }).default("20000"), // VCA Digital Share (200 shares = 20,000 VCA for early franchise)
});
...
export const staff = pgTable("staff", {
  ...
  vcaDigitalShare: decimal("vca_digital_share", { precision: 15, scale: 2 }).default("0"), // VCA Digital Share earned from KPI (1 KPI point = 10 VCA)
  updatedAt: timestamp("updated_at").defaultNow(),
});
...
export const transactions = pgTable("transactions", {
  ...
  vcaDigitalShareAmount: decimal("vca_digital_share_amount", { precision: 15, scale: 2 }).default("0"), // Số VCA Digital Share tương ứng
  branchId: varchar("branch_id").references(() => branches.id),
  cardId: varchar("card_id").references(() => cards.id),
...
export const staffKpis = pgTable("staff_kpis", {
  ...
  vcaDigitalShareEarned: decimal("vca_digital_share_earned", { precision: 15, scale: 2 }).default("0"), // VCA Digital Share earned (1 KPI point = 10 VCA)
...
export const referrals = pgTable("referrals", {
  ...
  vcaDigitalShareAmount: decimal("vca_digital_share_amount", { precision: 15, scale: 2 }).default("0"), // VCA Digital Share from 8% CTV commission
...
export const profitDistribution = pgTable("profit_distribution", {
  ...
  vcaDigitalShareAmount: decimal("vca_digital_share_amount", { precision: 15, scale: 2 }).default("0"), // VCA Digital Share phân phối
...
// VCA Digital Share history for tracking VCA Digital Share changes
...
export const insertPadTokenHistorySchema = createInsertSchema(vcaDigitalShareHistory).omit({
  id: true,
  createdAt: true,
});
...
export type PadTokenHistory = typeof vcaDigitalShareHistory.$inferSelect;
